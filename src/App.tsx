  ...
  return (
    <section className="">
      <div className="container py-6">
        {/* ToolBar */}
        <div className="flex items-center justify-between gap-2 flex-col space-y-2 pb-3 border-b border-solid">
          <SearchInput onSearch={setSearchTerm} />
          <DateFilter onFilterChange={setFilterDeadline} />
          <div className="flex gap-3 overflow-auto [&::-webkit-scrollbar]:hidden">
            <Button
              variant='ghost'
              className={filterState === 'pending' ? 'bg-primary' : ''}
            ...
            <Button
              variant='ghost'
              className={filterState === 'completed' ? 'bg-primary' : ''}
